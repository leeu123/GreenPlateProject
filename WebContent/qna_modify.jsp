...
<body>
	...
	<section style="min-height: 604px">
		<div id="write-bar">
			<form class="form-horizontal" role="form" action="boardModifyPro.bo" method="post" name = "modifyform">
				<input type = "hidden" name = "qnum" value = "<%=article.getQnum()%>"/>
				<div class="form-group">
					<label for="qtitle" class="col-sm-2 control-label">제목</label>
					<div class="col-sm-10">
						<input type="text" class="form-control"
							placeholder="게시글 제목을 입력하세요" value = "<%=article.getQtitle()%>" name="qtitle"
							required="required">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="작성자를 입력하세요"
								value = "<%=article.getNick()%> " name="nick" required="required">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" rows="10" name="qcontent"
							required="required"><%=article.getQcontent()%></textarea>
					</div>
				</div>
