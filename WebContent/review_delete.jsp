...
<body>
	...
	<section style="min-height: 604px">
		<div id="write-bar">
			<form class="form-horizontal" role="form" name="deleteForm" action="reviewDeletePro.bo?board_num=<%=board_num %>" method="post">
				<input type = "hidden" name = "page" value = "<%=nowPage %>"/>
				
				<div class="form-group">
					<label for="rpass" class="col-sm-2 control-label">글 비밀번호</label>
					<div class="col-sm-10">
						<input type="password" class="form-control"
							placeholder="글 비밀번호를 입력하세요" name="rpass">
					</div>
				</div>
